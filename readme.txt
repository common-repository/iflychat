...
* **Embedded Chat Room**: Make different chat rooms into separate pages. Fully customisable CSS. [Check out the features here](https://www.iflychat.com/features?refid=wp).
...
* **Chat Logging**: Retrieve logs of your chat rooms using our custom [shortcode](https://docs.iflychat.com/wordpress/view-chat-logs?refid=wp).
...
For advanced features (such as embed chat, group chat, etc) and scalability, we offer paid plans - [https://www.iflychat.com/pricing](https://www.iflychat.com/pricing?refid=wp).

PS: You'll need an [iFlyChat.com API key](https://v2.iflychat.com/dashboard?refid=wp) to use chat.

== Installation ==

* Upload the iFlyChat plugin to your WordPress site.
* Activate it.
* Get [iFlyChat.com API key](https://v2.iflychat.com/dashboard?refid=wp). You need to first create an account [here](https://v2.iflychat.com/user/register?refid=wp).
* Detailed installation steps - [https://docs.iflychat.com/installation/wordpress-chat-plugin](https://docs.iflychat.com/installation/wordpress-chat-plugin?refid=wp).
* You're done!
...
Please open a support ticket if have any query or need assistance - [https://www.iflychat.com/contact](https://www.iflychat.com/contact?refid=wp).

= Do you have any knowledge base where I can see some documentation? =

Yes, you may view our knowledge base here - [https://docs.iflychat.com](https://docs.iflychat.com?refid=wp).
...
We provide a URL based filter on iFlyChat settings page to show/hide chat on/from specific pages of your WordPress website. More information here - [https://docs.iflychat.com/wordpress/show-hide-popup-chat-on-specific-pages](https://docs.iflychat.com/wordpress/show-hide-popup-chat-on-specific-pages?refid=wp).

== Changelog ==

= 4.7.2 =

09/11/2023: WordPress compatibility check with 6.4.

= 4.7.1 =

16/12/2022: WordPress compatibility check with 6.0.

= 4.7.0 =

01/02/2021: iFlyChat new backend update.

= 4.6.4 =

14/05/2019: iFlyChat new backend update.
